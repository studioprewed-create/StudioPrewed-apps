export function initBase() {
    ...
    if (waButtons.length) {
        waButtons.forEach((wa, index) => {
            // Mencegah event dan interval terpasang berulang
            if (wa.dataset.waInitialized === "true") {
                return;
            }

            wa.dataset.waInitialized = "true";
            ...
            // Nomor kedua muncul sedikit setelah nomor pertama
            setTimeout(showText, 2000 + (index * 1000));
