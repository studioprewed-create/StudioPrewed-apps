<section class="google-review-section" id="googleReviewSection">
    ...
    ========================================================= --}}
        ...
        <div class="google-review-filter" id="googleReviewFilter">
            ...
            <div class="google-filter-dropdown">
                ...
                <button class="google-filter-dropdown-btn" id="googleStarDropdownBtn">
                ...
                <div class="google-filter-dropdown-menu" id="googleStarDropdownMenu">
    ...
    ========================================================= --}}
        ...
        <div class="google-review-grid" id="googleReviewGrid">
            ...
            @foreach ($googleReviews as $review)
                ...
                <div class="google-review-card" data-rating="{{ $review->rating }}"
                    data-photo="{{ count($images) ? 1 : 0 }}" data-date="{{ $review->review_date }}">
                    ...
                    <div class="google-review-top">
                        ...
                        <div class="google-review-user">
                            ...
                            @if ($review->profile_photo)
                                <img src="{{ asset($review->profile_photo) }}" alt="{{ $review->author_name }}">
                            @else
                ...
                ========================================================= --}}
                    ...
                    <button class="google-review-more" data-author="{{ $review->author_name }}"
                    ...
                    {{-- @if (count($images))
                        <div class="google-review-images">
                            ...
                            @foreach ($images as $img)
                                <img src="{{ asset($img) }}" alt="review image" class="google-review-image-item"
    ...
    ========================================================= --}}
        ...
        <div class="google-review-pagination" id="googleReviewPagination">
        </div>
...
<div class="google-review-modal" id="googleReviewModal">
    ...
    <div class="google-review-modal-content">
        ...
        <button class="google-review-modal-close" id="googleReviewClose">
        ...
        <div class="google-review-modal-user">
            ...
            <div class="google-review-modal-avatar" id="modalAvatar">
                A
            </div>
            ...
            <div>
                ...
                <div class="google-review-stars" id="modalStars">
                </div>
        ...
        <div class="google-review-modal-text" id="modalText">
        </div>
...
<div class="google-image-modal" id="googleImageModal">
    ...
    {{-- BACKDROP --}}
    <div class="google-image-backdrop">
    </div>

    {{-- CLOSE --}}
    <button class="google-image-close" id="googleImageClose">
    ...
    {{-- PREV --}}
    <button class="google-image-nav prev" id="googleImagePrev">
    ...
    {{-- NEXT --}}
    <button class="google-image-nav next" id="googleImageNext">
    ...
    {{-- IMAGE --}}
    <img src="" alt="review image" id="googleImagePreview">
