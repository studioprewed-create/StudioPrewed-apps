            ...
            <div class="akun-container">
                ...
                <div class="profile-info with-line">
                    ...
                    <div class="info-group">
                        ...
                        <div class="info-value">
                            {{ optional($dataDiri)->tanggal_lahir ? \Carbon\Carbon::parse($dataDiri->tanggal_lahir)->format('d F Y') : '-' }}
                        </div>
                    </div>
                ...
                <details class="acc" id="accountDetails" @if ($errors->any()) open @endif
                    ...
                    <div class="acc-body">
                        <form class="form-inline" method="POST"
                            action="{{ $dataDiri ? route('Account.update', $dataDiri->id) : route('Account.store') }}">
                            @csrf
                            @if ($dataDiri)
                                @method('PUT')
                            @endif
                            ...
                            <div class="account-form-group">
                                ...
                                <input class="input" id="phone" type="text" name="phone"
                                    placeholder="No HP / WA" value="{{ old('phone', optional($dataDiri)->phone) }}">
                            ...
                            <div class="account-form-group" style="margin-top:16px;">
                                ...
                                <input class="input" id="tanggal_lahir_pasangan" type="date"
                        ...
                        @if ($dataDiri)
                            <form method="POST" action="{{ route('Account.destroy', $dataDiri->id) }}"
