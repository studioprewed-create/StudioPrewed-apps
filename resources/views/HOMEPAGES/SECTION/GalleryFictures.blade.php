<div class="floating-middlebar" id="Portofolio">
    <div class="middlebar-container">
        <div class="gallery-filter">
            ...
            <button class="filter-btn {{ $selectedCategory === 'postwedding' ? 'active' : '' }}"
                data-filter="postwedding">
...
<section class="gallery-section" id="gallery" data-initial-filter="{{ $selectedCategory ?? 'all' }}">
    ...
    <div class="gallery-grid">
        @forelse($galleries as $g)
            ...
            <div class="gallery-item" data-category="{{ $cat }}" data-img="{{ $img }}"
                data-title="{{ e($g->title) }}" data-desc="{{ e($g->description) }}">
