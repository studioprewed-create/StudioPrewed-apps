...
<head>
    ...
    <title>Studio Prewed | Potrait Timeless | Pricelist</title>
...
<body>
        ...
        window.__TEMA_DICT__ = @json(
            $temas->groupBy('nama')->map(function ($g) {
                return $g->map(function ($t) {
                    return ['id' => $t->id, 'nama' => $t->nama, 'kode' => $t->kode];
                });
            }));
    ...
    <a href="#packages-container" class="section-float" data-down-target="#packages-container"
        data-down-text="Explore Pricelist" data-up-target="#home" data-up-text="Back To Top"
