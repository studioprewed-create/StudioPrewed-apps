        ...
        <form class="review-form" action="{{ route('review.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="rf-grid">
                <div class="rf-field">
                    ...
                    <input class="rf-input" type="number" name="rating" placeholder="5" min="1" max="5"
                        required>
                </div>
                <div class="rf-field">
...
<style>
    ...
    .review-form .rf-input::placeholder {
        color: #b0b0b0;
    }

    .review-form .rf-input:focus {
        border-color: #6366f1;
    ...
    .review-form .rf-btn:hover {
        filter: brightness(1.07);
        transform: translateY(-1px);
    }

    .review-form .rf-btn:active {
...
<script>
    (function() {
        ...
        modal.addEventListener('click', (e) => {
            if (e.target.classList.contains('rf-modal__backdrop')) hide();
        });
