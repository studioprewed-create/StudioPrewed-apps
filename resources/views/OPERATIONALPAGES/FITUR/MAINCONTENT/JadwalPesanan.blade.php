        ...
        @forelse ($bookings as $booking)
            <div class="order-card">
                ...
                <div class="order-actions">
                    <button class="action-btn btn-view js-open-booking-modal" data-cpp="{{ $booking->nama_cpp }}"
                        data-cpw="{{ $booking->nama_cpw }}" data-email-cpp="{{ $booking->email_cpp }}"
                        data-email-cpw="{{ $booking->email_cpw }}" data-phone-cpp="{{ $booking->phone_cpp }}"
                        data-phone-cpw="{{ $booking->phone_cpw }}" data-alamat-cpp="{{ $booking->alamat_cpp }}"
                        data-alamat-cpw="{{ $booking->alamat_cpw }}" data-ig-cpp="{{ $booking->ig_cpp }}"
                        data-ig-cpw="{{ $booking->ig_cpw }}" data-tiktok-cpp="{{ $booking->tiktok_cpp }}"
                        data-tiktok-cpw="{{ $booking->tiktok_cpw }}" data-package-id="{{ $booking->package_id }}"
                        ...
                        data-slot="{{ $booking->photoshoot_slot }}" data-slot-code="{{ $booking->slot_code }}"
                        data-start="{{ $booking->start_time }}" data-end="{{ $booking->end_time }}"
                        ...
                        data-extra-minutes="{{ $booking->extra_minutes }}" data-tema-id="{{ $booking->tema_id }}"
                        data-tema-kode="{{ $booking->tema_kode }}" data-tema-nama="{{ $booking->tema_nama }}"
                        data-tema2-id="{{ $booking->tema2_id }}" data-tema2-kode="{{ $booking->tema2_kode }}"
                        data-tema2-nama="{{ $booking->tema2_nama }}" data-style="{{ $booking->style }}"
                        ...
                        data-kode="{{ $booking->kode_pesanan }}" data-status="{{ $booking->status }}"
                        data-notes="{{ $booking->notes }}">
                        Lihat Detail
                    </button>
                    @if (in_array(auth()->user()->role, ['ADMIN', 'DIREKTUR']))
                        <button type="button" class="action-btn btn-edit js-open-booking-edit">
                            <i class="fas fa-edit"></i> Edit
                        </button>
                        <form
                            action="{{ route('executive.homepages.destroy', ['section' => 'bookingexecutive', 'id' => $booking->id]) }}"
                ...
                <form method="POST"
                    ...
                    <div class="booking-container">
                        ...
                        <div class="card-section" style="margin-top:20px">
                            ...
                            <textarea name="notes" id="notes" placeholder="Catatan tambahan" rows="3"></textarea>
                        </div>
                        ...
                        <div class="grid-2">
                            ...
                            <div>
                                ...
                                <select id="tema_kode" name="tema_kode" disabled>
                                    ...
                                    @foreach ($temas as $t)
                                        <option value="{{ $t->kode }}" data-tema-id="{{ $t->id }}"
                                            data-nama="{{ $t->nama }}">
                                            {{ $t->kode }} - {{ $t->nama }}
                                        </option>
                                    @endforeach
