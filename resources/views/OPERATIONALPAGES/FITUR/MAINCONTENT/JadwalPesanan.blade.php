                ...
                <div class="order-details">
                    ...
                    <div class="detail-group">
                        ...
                        <span class="detail-value">
                            {{ \Carbon\Carbon::parse($booking->photoshoot_date)->format('d M Y') }}
                        </span>
                    </div>
                    <div class="detail-group">
                ...
                <div class="booking-modal" id="bookingModal-{{ $booking->id }}">
                    ...
                    <div class="booking-modal-content">
                        ...
                        <div class="modal-grid">
                            <div><strong>Kode</strong><br>#{{ $booking->kode_pesanan }}</div>
                            ...
                            <div><strong>Tema Utama</strong><br>{{ $booking->tema_nama }}</div>
